      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="dashboard" className="w-full">
          ...
          <TabsList className="grid w-full grid-cols-7 mb-8">
            ...
            {/* AJOUTE CET ONGLET : */}
            <TabsTrigger value="relations">Relations Personnes</TabsTrigger>
            <TabsTrigger value="relationsAliment">Relations Aliments</TabsTrigger>
          ...
          {/* AJOUTE CE CONTENU POUR L'ONGLET RELATIONS : */}
          <TabsContent value="relations">
            <GestionRelationsPersonne />
          </TabsContent>
          <TabsContent value="relationsAliment">
            <GestionRelationsAliment />
          </TabsContent>
        </Tabs>
      </main>
    </div>
